...
public class LaptopsAndNoteBooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() {
        ...
        verifyTextElement("Success: You have modified your shopping cart!", By.xpath("//div[@class='alert alert-success alert-dismissible']"));
        ...
        verifyTextElement("Warning: Payment method required!", By.xpath("//div[@class='alert alert-danger alert-dismissible']"));
    }
